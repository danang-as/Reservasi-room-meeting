                    ...
                    <tbody>
                      ...
                      @foreach ($reservasi as $item)
                        <tr>
                            ...
                            <td>{{ $item->jumlah_panitia }}</td>
                            <td>{{ $item->nama_ruangan }}</td>
                            <td>{{ $item->direktorat }}</td>
                            <td>{{ $item->divisi }}</td>
                            <td>{{ $item->bagian }}</td>
                            <td>{{ $item->pendukung }}</td>
                            <td>{{ $item->status }}</td>
                            <td>
                                <a href="{{ url('laporan/export/csv') }}" class="btn btn-primary">Export CSV</a>
                                <a href="{{ url('laporan/export/pdf') }}" class="btn btn-primary">Export PDF</a>
                            </td>
                        </tr>
                        @endforeach
                        <tr>
