...
@section('content')
      ...
      <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Edit Data direktorat</h4>
            </div>
          </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="container-fluid">
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Form Edit Data Direktorat</h5>
                  <div class="table-responsive">
                    ...
                    <form action="{{url('data_direktorat/'.$data_direktorat->id_direktorat)}}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="my-3 p-3 bg-body rounded shadow-sm">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name='nama_direktorat' value="{{ $data_direktorat->nama_direktorat }}" id="nama_direktorat">
                                </div>
                        </div>
                        <div class="mb-3 row">
