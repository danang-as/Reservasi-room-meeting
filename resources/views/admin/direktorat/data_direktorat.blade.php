                  ...
                  <div class="table-responsive">
                    ...
                    >
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="{{ url('data_direktorat/'.$item->id_direktorat.'/edit')}}" class="btn btn-primary ml-3 font-bold"><i class="fas fa-pen-square mr-2"></i>Edit</a>
                          <form  onsubmit="return confirm('Yakin akan menghapus data?')" class="d-inline" action="{{ url('data_direktorat/'.$item->id_direktorat)}}" method="post">
                            @csrf
                            @method('DELETE')
