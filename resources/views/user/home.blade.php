...
<div class="w-[412px] h-[915px] relative bg-white">
    ...
    <button type="submit"  onclick="window.location='{{ url('reschedule') }}'" class="w-[220px] h-[60px] left-[105px] top-[590px] text-white rounded-bl-[30px] rounded-tr-[30px] absolute bg-orange-600">Reschedule</button>
