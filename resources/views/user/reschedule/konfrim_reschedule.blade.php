...
<head>
    ...
    <title>Konfirmasi Reschedule</title>
    <link
      rel="icon"
      type="image/png"
      sizes="16x16"
...
<div class="w-[412px] h-[915px] relative bg-blue-950">
    ...
    <div class="left-[17px] top-[112px] absolute text-white text-[40px] font-normal font-['Inter']">Reschedule</div>
    ...
    <div class="flex items-center">
      <input id="default-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-bl-[10px] focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-100 dark:border-gray-900 left-[30px] top-[650px] absolute text-black text-sm font-normal font-['Inter']">
    ...
    <button type="submit" onclick="window.location='{{ url('pendukung_reschedule') }}'" class="w-20 h-10 left-[32px] top-[790px] text-white absolute rounded-bl-[30px]  absolute bg-blue-950">Back</button>
</div>
